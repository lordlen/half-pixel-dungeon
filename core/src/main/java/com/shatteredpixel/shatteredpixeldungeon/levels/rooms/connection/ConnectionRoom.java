...
public abstract class ConnectionRoom extends Room {
	...
	static {
		...
		chances[2] = chances[1];
		chances[3] =  new float[]{20, 0,    0, 0,       0, 0};
		
		chances[4] =  new float[]{0, 0,     22, 3,      0, 0};
		chances[5] = chances[6] = chances[4];
		
		chances[7] = new float[]{12, 0,    0, 5,       5, 3};
		chances[8] = chances[9] = chances[7];
		
		chances[10] = new float[]{0, 0,     18, 3,      3, 1};
		chances[11] = chances[10];
		
		chances[12] = chances[3];
		
		chances[13] = new float[]{15, 4,    0, 2,       3, 2};
